/*
 ...
 Description : Write a program that requests the user’s first name and then the
               ...
               the number of letters in each name on the following line. Align
               each letter count with the end of the corresponding name, as in the
               following:
                Melissa Honeybee
                      7        8
...
int main(void)
{
    ...
    printf("%*zd %*zd\n", (int)first_name_length, first_name_length, (int)last_name_length, last_name_length);
